export const LORA_PROFILES = [
  ...
  {
    id: "arknights-endfield-operators-anima-v3",
    name: "アークナイツ：エンドフィールド オペレーターズコレクション v3.0（31キャラ）",
    category: "character",
    baseModel: "Anima",
    versionId: 3049218,
    sourceUrl: "https://civitai.com/models/2425904?modelVersionId=3049218",
    filename: "anima-base-1-arknights-endfield-v31.safetensors",
    match: ["anima-base-1-arknights-endfield-v31", "Arknights: Endfield | Operators Collection"],
    recommendedWeight: 0.75,
    defaultPreset: "identity",
    note: "Civitai v3.0 [anima-base-1] の作者記載Triggerをキャラクター別に登録。通常22件、v1.1 4件、未実装3件、敵対者2件の計31件。PogranichnikとEmberは作者が修正対象として明記しているため未登録。",
    presets: [
      { id: "identity", name: "キャラ指定なし", triggerWords: "solo, alternate costume" },
      { id: "female-endministrator", name: "女性管理人（female endministrator）", triggerWords: "female endministrator \\(arknights\\)" },
      { id: "male-endministrator", name: "男性管理人（male endministrator）", triggerWords: "male endministrator \\(arknights\\)" },
      { id: "perlica", name: "ペリカ（Perlica）", triggerWords: "perlica \\(arknights\\)" },
      { id: "chen-qianyu", name: "チェン・センユー（Chen Qianyu）", triggerWords: "chen qianyu \\(arknights\\)" },
      { id: "akekuri", name: "アケクリ（Akekuri）", triggerWords: "akekuri \\(arknights\\)" },
      { id: "alesh", name: "アレシュ（Alesh）", triggerWords: "alesh \\(arknights\\)" },
      { id: "antal", name: "アンタル（Antal）", triggerWords: "antal \\(arknights\\)" },
      { id: "arclight", name: "アークライト（Arclight）", triggerWords: "arclight \\(arknights\\)" },
      { id: "ardelia", name: "アルデリア（Ardelia）", triggerWords: "ardelia \\(arknights\\)" },
      { id: "avywenna", name: "アイビーエナ（Avywenna）", triggerWords: "avywenna \\(arknights\\)" },
      { id: "catcher", name: "キャッチャー（Catcher）", triggerWords: "catcher \\(arknights\\)" },
      { id: "da-pan", name: "ダパン（Da Pan）", triggerWords: "da pan \\(arknights\\)" },
      { id: "estella", name: "エステーラ（Estella）", triggerWords: "estella \\(arknights\\)" },
      { id: "fluorite", name: "フローライト（Fluorite）", triggerWords: "fluorite \\(arknights\\)" },
      { id: "gilberta", name: "ギルベルタ（Gilberta）", triggerWords: "gilberta \\(arknights\\)" },
      { id: "laevatain", name: "レーヴァテイン（Laevatain）", triggerWords: "laevatain \\(arknights\\)" },
      { id: "last-rite", name: "ラストライト（Last Rite）", triggerWords: "last rite \\(arknights\\)" },
      { id: "lifeng", name: "リーフォン（Lifeng）", triggerWords: "lifeng \\(arknights\\)" },
      { id: "snowshine", name: "スノーシャイン（Snowshine）", triggerWords: "snowshine \\(arknights\\)" },
      { id: "wulfgard", name: "ウルフガード（Wulfgard）", triggerWords: "wulfgard \\(arknights\\)" },
      { id: "xaihi", name: "ザイヒ（Xaihi）", triggerWords: "xaihi \\(arknights\\)" },
      { id: "yvonne", name: "イヴォンヌ（Yvonne）", triggerWords: "yvonne \\(arknights\\)" },
      { id: "mi-fu", name: "ミ・フ（Mi Fu・v1.1）", triggerWords: "mi fu \\(arknights\\)" },
      { id: "rossi", name: "ロッシ（Rossi・v1.1）", triggerWords: "rossi \\(arknights\\)" },
      { id: "tangtang", name: "タンタン（Tangtang・v1.1）", triggerWords: "tangtang \\(arknights\\)" },
      { id: "zhuang-fangyi", name: "ゾアン・ファンイ（Zhuang Fangyi・v1.1）", triggerWords: "zhuang fangyi \\(arknights\\)" },
      { id: "arcane", name: "アーケイン（Arcane・未実装）", triggerWords: "arcane \\(arknights\\)" },
      { id: "camille", name: "カミーユ（Camille・未実装）", triggerWords: "camille \\(arknights\\)" },
      { id: "feranmut-proxy", name: "フェラムート・プロキシ（Feranmut Proxy・未実装）", triggerWords: "feranmut proxy \\(arknights\\)" },
      { id: "ardashir", name: "アルダシール（Ardashir・敵対者）", triggerWords: "ardashir \\(arknights\\)" },
      { id: "nefarith", name: "ネファリス（Nefarith・敵対者）", triggerWords: "nefarith \\(arknights\\)" }
    ]
  },
  {
